...
public class ClassRecordsTest {
    ...
    public void setUp() {
        ...
        Student firstStudent = new Student("Kovács Rita", new ArrayList<>());
        Student secondStudent = new Student("Nagy Béla", new ArrayList<>());
        Student thirdStudent = new Student("Varga Márton", new ArrayList<>());
    ...
    public void testAddStudentAlreadyExists() {
        assertFalse(classRecords.addStudent(new Student("Nagy Béla", new ArrayList<>())));
