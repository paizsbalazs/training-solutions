...
import static schoolrecords.MarkType.A;
...
public class StudentTest {
    ...
    public void emptyNameShouldThrowException() throws IllegalArgumentException {
        ...
        Exception ex = assertThrows(IllegalArgumentException.class, () -> new Student("", Arrays.asList() ));
    ...
    public void testGrading() {
        //Given
        Student student = new Student("Kovács", new ArrayList<>());
        //When
